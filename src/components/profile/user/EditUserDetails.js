  ...
  settingUserDetail = e => {
    ...
    if (userDetails.photoURL == "" && userDetails.headerPhotoURL == "") {
      ...
      if (
        ...
        this.state.headerPhoto.length === 0
      ) {
        console.log("Ashish");
        db.collection("users")
          .doc(this.state.user.userId)
        ...
        console.log("Ashish");
        const storageRef = file.ref(
          "uploads/" +
            this.state.user.userId +
            "/profile/" +
            this.state.photo[0].name
        );
        storageRef.put(this.state.photo[0]).then(snap => {
          ...
          snap.ref.getDownloadURL().then(url => {
            ...
            db.collection("users")
              ...
              .update(userDetails);
            this.setState({
              updation: "Successfully updated the bio and the profile photo."
            });
        ...
        storageRef.put(this.state.headerPhoto[0]).then(snap => {
          ...
          snap.ref.getDownloadURL().then(url => {
            ...
            db.collection("users")
              ...
              .update(userDetails);
            this.setState({
              updation: "Successfully updated the bio and the header photo."
            });
      ...
      <div>
        ...
        >
          <div className="edit-page-header-image">
            ...
            <img src={this.state.headerPhotoURL} alt=""/>
          </div>
          ...
          <div className="edit-page-bio-textarea">
            <label htmlFor="bio" style={{ paddingBottom: "0.3rem" }}>
              Bio
            </label>
            <textarea
